...
<%@ page trimDirectiveWhitespaces="true" %>
	<%
	    ...
	    URL url = new URL(urlBuilder.toString()); //StringBuilder로 파라미터를 추가하여 url 생성
	    ...
	    String line;
	    while ((line = rd.readLine()) != null) { //한줄씩 읽기
	        sb.append(line);	//한줄씩 StringBuilder에 추가
	    }
	    rd.close();
	    conn.disconnect();
